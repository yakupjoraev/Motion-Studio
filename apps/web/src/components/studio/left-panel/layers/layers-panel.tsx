 ...
 *
 * The drag layer is mounted here rather than around the studio (ADR-137): this panel is the only
 * surface that drags today, and it is a chunk the studio downloads when the tab is opened.
 */
