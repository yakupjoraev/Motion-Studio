...
export const playground: Dictionary['playground'] = {
  ...
  propertySummaries: {
    background: 'Градиенты и слои на прямоугольнике во всю ширину.',
    'box-shadow': 'Карточка на поверхности средней светлоты, где тень действительно видно.',
    filter: 'Цепочка функций сразу над картинкой, текстом и градиентом.',
    'backdrop-filter': 'Стеклянная панель над пёстрым фоном — только там это свойство и читается.',
    'mask-image': 'Шахматка за картинкой, чтобы было видно, что именно убрала маска.',
    'clip-path': 'Сетка поверх фигуры, чтобы многоугольник читался в процентах.',
    transform: 'Карточка в контейнере с перспективой, где трёхмерные трансформации имеют смысл.',
    transition: 'Два состояния и прокрутка, чтобы кривую можно было смотреть, а не угадывать.',
  },
}
