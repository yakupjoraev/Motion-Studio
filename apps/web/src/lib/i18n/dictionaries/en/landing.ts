...
export const landing = {
  ...
  export: {
    ...
    intro:
      'React, Next, plain HTML or JSON. Typed props, hoisted constants, honest class names, and no runtime of ours in the output. This file was generated by the shipped exporter when this page was built.',
