 ...
 */
export const heroSplitGridStyles = cva(
  'grid w-full items-center gap-10 @min-[1024px]/frame:gap-16',
  {
    variants: {
      ratio: {
        even: '@min-[1024px]/frame:grid-cols-2',
        'text-wide': '@min-[1024px]/frame:grid-cols-[1.25fr_1fr]',
        'media-wide': '@min-[1024px]/frame:grid-cols-[1fr_1.25fr]',
      },
    },
  },
)
...
export const heroSplitTextStyles = cva('min-w-0', {
  variants: {
    reverse: { true: '@min-[1024px]/frame:order-2', false: '@min-[1024px]/frame:order-1' },
  },
})

export const heroSplitMediaStyles = cva('min-w-0', {
  variants: {
    reverse: { true: '@min-[1024px]/frame:order-1', false: '@min-[1024px]/frame:order-2' },
  },
})
