 ...
 */
export const CTA_SPLIT_GRID =
  'grid items-center gap-10 @min-[1024px]/frame:grid-cols-[3fr_2fr] @min-[1024px]/frame:gap-16'

export const ctaSplitPanelStyles = cva(
  'rounded-2xl px-6 py-12 @min-[768px]/frame:px-10 @min-[768px]/frame:py-14',
  {
    variants: {
      surface: {
...
export const CTA_SPLIT_HEADING =
  'mt-4 mb-0 max-w-[24ch] text-balance font-semibold text-2xl text-foreground first:mt-0 @min-[768px]/frame:text-3xl'
